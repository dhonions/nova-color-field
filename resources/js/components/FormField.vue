  ...
  <default-field :field="field" class="color-picker-field">
    <template slot="field">
      ...
      />
        ...
        <div v-show="palette">
            <span @click="handleRawInputCustom(item)" class="custom-pallette-color" v-for="item in palette" v-bind:style="{ background: item }"></span>
        </div>
